 ...
 * @property string|null $msg_category_id
 * @property string|null $schedule_date
 */
class AlertsSchedule extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['uid'], 'integer'],
            [['created_at', 'updated_at','message_type','schedule_date'], 'safe'],
            //[['message_type'], 'string', 'max' => 200],
            [['msg_category_id'], 'string', 'max' => 200],
