...
class ContributionTrend extends \yii\db\ActiveRecord
{
 ...
 public $member_number;
    ...
    {
        return [
            [['member_id', 'ContributionYear', 'JANUARY', 'FEBRUARY', 'MARCH', 'APRIL', 'MAY', 'JUNE', 'JULY', 'AUGUST', 'SEPTEMBER', 'OCTOBER', 'NOVEMBER', 'DECEMBER', 'JANUARYC', 'FEBRUARYC', 'MARCHC', 'APRILC', 'MAYC', 'JUNEC', 'JULYC', 'AUGUSTC', 'SEPTEMBERC', 'OCTOBERC', 'NOVEMBERC', 'DECEMBERC', 'AnnualMonthsContributed', 'AnnualSalaryContributed', 'AnnualTotalContributed'], 'required'],
    ...
    {
        return $this->hasOne(Members::className(), ['member_sys_id' => 'member_id']);
    }
