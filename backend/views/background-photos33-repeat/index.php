...
<div class="clerk-deni-index" style="padding-top: 10px">
    ...
    $pdfHeader = [
        'L' => [
            'content' =>Yii::t('yii','APPLICATION IMAGES'),
        ],
        'C' => [
    ...
    <?php $gridColumns = [
       ...
       // 'image:ntext',
        [
            ...
            'format' => 'html',
//            'value' => function ($data) {
//                return Html::img('/../../api/' . $data['image'],
...
//            },
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            'heading' => '<i class="fa fa-bars"></i>'.Yii::t('yii','LIST OF APPLICATION IMAGES'),
        ...
        'exportConfig' => [
            GridView::PDF => [
                ...
                'showPageSummary' => true,
                'showFooter' => true,
                'filename' => Yii::t('yii', 'LIST OF IMAGES'),
