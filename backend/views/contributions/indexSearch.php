...
<div class="clerk-deni-index" style="padding-top: 10px">
    ...
    $pdfHeader = [
        'L' => [
            'content' => Yii::t('yii', 'MEMBERS LATEST CONTRIBUTIONS'),
        ],
        'C' => [
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            'heading' => '<i class="fa fa-bars"></i>' . Yii::t('yii', 'MEMBERS LATEST CONTRIBUTIONS'),
        ...
        'exportConfig' => [
            GridView::PDF => [
                ...
                'showPageSummary' => true,
                'showFooter' => true,
                'filename' => Yii::t('yii', 'LIST OF ZSSF MEMBERS CONTRIBUTIONS'),
