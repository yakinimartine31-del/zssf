...
$this->title ='';
$this->params['breadcrumbs'][] = Yii::t('yii', 'Employers');
?>
<div class="clerk-deni-index" style="padding-top: 10px">
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            'heading' => '<i class="fa fa-bars"></i>'.Yii::t('yii','LIST OF ALL EMPLOYERS'),
        ...
        'exportConfig' => [
            GridView::PDF => [
                ...
                'showPageSummary' => true,
                'showFooter' => true,
                'filename' => Yii::t('yii', 'LIST OF EMPLOYERS'),
