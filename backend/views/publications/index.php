...
<div class="clerk-deni-index" style="padding-top: 10px">
    ...
    $pdfHeader = [
        ...
        'C' => [
            'content' => Html::a(Html::img('../images/login.png', ['alt' => 'image', 'class' => 'image', 'height' => '80'])) . '<br>' . Yii::t('yii', 'LIST PUBLICATIONS') . '<br>',
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            'heading' => '<i class="fa fa-bars"></i>' . Yii::t('yii', 'LIST OF PUBLICATIONS'),
            'type' => GridView::TYPE_SUCCESS,
            'before' => Html::a(Yii::t('yii', 'New Publication'), ['create'], ['class' => 'btn btn-success']),
        ],
        'exportConfig' => [
            GridView::PDF => [
                ...
                'showPageSummary' => true,
                'showFooter' => true,
                'filename' => Yii::t('yii', 'LIST OF PUBLICATION'),
