...
<div class="clerk-deni-index" style="padding-top: 10px">
    ...
    $pdfHeader = [
        'L' => [
            'content' =>Yii::t('yii','FEEDBACK REPORT'),
        ],
        'C' => [
            'content' => Html::a(Html::img('../images/login.png', ['alt' => 'image', 'class' => 'image', 'height' => '80'])) . '<br>' . 'LIST OF MEMBER FEEDBACK' . '<br>',
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            'heading' => '<i class="fa fa-bars"></i>'.Yii::t('yii','LIST OF SUBMITTED MEMBERS FEEDBACK'),
        ...
        'exportConfig' => [
            GridView::PDF => [
                ...
                'showPageSummary' => true,
                'showFooter' => true,
                'filename' => Yii::t('yii', 'MEMBERS CONTACTED US'),
