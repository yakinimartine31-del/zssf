...
$this->title = '';
$this->params['breadcrumbs'][] = Yii::t('yii', 'Users');
?>
...
//        'updated_at',
    ...
    echo \kartik\grid\GridView::widget([
             ...
             //   Html::beginForm(['users/new'],'post'),
                Html::button("<span class='fa fa-plus' aria-hidden='true'></span>",
                    ['class' => 'btn btn-success',
                        'onclick'=>"window.location.href = '" . \Yii::$app->urlManager->createUrl(['users/new']) . "';",
                        'data' => [
                        'confirm' => Yii::t('app', 'Are you sure you want to create new user ?'),
                        'method' => 'post',
        ...
        'panel' => [
            'heading' => '<i class="fa fa-bars"></i>' . Yii::t('yii', 'LIST OF USERS'),
        ...
        'exportConfig' => [
            GridView::PDF => [
                ...
                'showPageSummary' => true,
                'showFooter' => true,
                'filename' => Yii::t('yii', 'LIST USERS LOGIN ACCOUNTS'),
