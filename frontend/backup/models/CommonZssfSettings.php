...
class CommonZssfSettings extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['complaints_email_address', 'hq_mobile_number', 'pemba_mobile_number', 'contact_email', 'unguja_phone_number', 'facebook_link', 'twitter_link', 'instagram_link', 'pemba_cordinates', 'unguja_cordinates', 'youtube_link', 'host_server', 'db_user', 'db_password', 'database_name', 'head_office_fax_number', 'pemba_fax_number'], 'string', 'max' => 255],
        ];
    }
