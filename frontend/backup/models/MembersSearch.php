...
class MembersSearch extends Members
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['date_time', 'full_names', 'membership_number', 'email', 'password', 'uid', 'group', 'username', 'mobile_number', 'member_sys_id', 'photo', 'send_auth_code_via', 'auth_code', 'date_of_birth', 'address', 'marital_status', 'gender', 'national_id', 'member_card'], 'safe'],
        ];
    }
