    ...
    $wizard_config = [
        ...
        'steps' => [
            ...
            2 => [
                ...
                'content' => $this->render('otp_sign_up',['otp'=>$otp]),
                'skippable' => false,
                'save' => false,
            ],
            3 => [
                ...
                'content' => $this->render('reset_form',['user'=>$user]),
                'skippable' => false,
                'save' => false,
            ],
        ],
    ...
    $wizard_config1 = [
        ...
        'steps' => [
            ...
            3 => [
                'title' => Yii::t('yii','Member Information'),
                'icon' => 'glyphicon glyphicon-user',
                'content' =>Yii::$app->session->getFlash('otp_success') ? $this->render('reset_form',['user'=>$user]) : '',
                'skippable' => false,
                'save' => false,
            ],
        ],
    ...
    $wizard_config3 = [
        ...
        'steps' => [
            ...
            3 => [
                'title' => Yii::t('yii','Member Information'),
                'icon' => 'glyphicon glyphicon-user',
                'content' =>Yii::$app->session->getFlash('details_fail') ? $this->render('reset_form',['user'=>$user]) : '',
