...
class CommonZssfSettings extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['date_time'], 'safe'],
            [['best_average_earning_months', 'refund_best_average_earning', 'max_calculator_months', 'max_calculator_years', 'employee_percentage'], 'integer'],
            [['maternity_fixed_amount', 'maternity_for_twins', 'percentage_deducted_on_refund', 'employer_percentge'], 'number'],
            [['footer_message'], 'string'],
            [['complaints_email_address', 'hq_mobile_number', 'pemba_mobile_number', 'contact_email', 'unguja_phone_number', 'facebook_link', 'twitter_link', 'instagram_link', 'pemba_cordinates', 'unguja_cordinates', 'youtube_link', 'host_server', 'db_user', 'db_password', 'database_name', 'head_office_fax_number', 'pemba_fax_number','hotline_no'], 'string', 'max' => 255],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'maternity_fixed_amount' => Yii::t('yii', 'Maternity for single delivery'),
            'maternity_for_twins' => Yii::t('yii', 'Maternity for twins delivery'),
