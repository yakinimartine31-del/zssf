        ...
        <div class="navbar-header">
            ...
            <?php if (Yii::$app->language == 'en') {
              //  echo Html::img('images/members2.png', ['alt' => 'logo', 'class' => 'profile-img', 'height' => '60px']);
                echo Html::img("https://mobile.zssf.or.tz/portal/images/members2.png", ['alt' => 'logo', 'class' => 'profile-img', 'height' => '60px']);
            } else {
              //  echo Html::img('images/members1.png', ['alt' => 'logo', 'class' => 'profile-img', 'height' => '60px']);
                echo Html::img("https://mobile.zssf.or.tz/portal/images/members1.png", ['alt' => 'logo', 'class' => 'profile-img', 'height' => '60px']);
            }
            ...
            <ul class="nav navbar-nav navbar-right"
                ...
                <li>
                    ...
                    if (Yii::$app->language == 'ru') {
                        ...
                        echo Html::a('ENGLISH', Url::current(['language' => 'en']), ['class' => (Yii::$app->request->cookies['language'] == 'en' ? 'active' : '')]);
                       ...
                       // echo Html::a(Html::img('flags/tz.png', ['alt' => 'flag', 'class' => 'flag',]), Url::current(['language' => 'ru']), ['class' => (Yii::$app->request->cookies['language'] == 'ru' ? 'active' : '')]);
                        echo Html::a('SWAHILI', Url::current(['language' => 'ru']), ['class' => (Yii::$app->request->cookies['language'] == 'ru' ? 'active' : '')]);
                    } else {
                        echo Html::a('SWAHILI', Url::current(['language' => 'ru']), ['class' => (Yii::$app->request->cookies['language'] == 'ru' ? 'active' : '')]);
                    }
                    ?>
                ...
                <?php if (!Yii::$app->user->isGuest) { ?>
                    ...
                    <li class="collapse" id="demo1">
                        <a href="<?= Url::toRoute(['contributions/view']) ?>"
                           class="list-group-item"><?= Yii::t('yii', 'Member Statement') ?></a>
                        <a href="<?= Url::toRoute(['contribution-trend/index']) ?>"
                           class="list-group-item"><?= Yii::t('yii', 'Contributions') ?></a>

                    </li>
                    <li style="list-style-type:none">
                        <a href="#demo2" class="list-group-item glyphicon glyphicon-gift"
                    ...
                    <li class="collapse" id="demo3">
                        <a href="<?= Url::toRoute(['applications-statuses/index']) ?>"
                           class="list-group-item"><?= Yii::t('yii', 'Benefit Application Status') ?> </a>
                ...
                <ul>
                    <li>
                        ...
                        <a title="Twitter" href="<?= $twitter ?>" target="_blank" rel="external nofollow"><i
                                    class="fa fa-twitter-square" style="font-size: 2em;"></i></a>
        ...
        <div class="row" style="color: white">
            <div class="col-md-12">
                <p class="pull-right">Copyright
                    ...
                    <?= Yii::t('yii', '. All Rights Reserved') ?>

                    <?= Html::a(Yii::t('yii', 'Privacy Policies'), 'https://www.privacypolicygenerator.info/live.php?token=CWQi6KL4lQo2XjFedNQm0AEtusqqKfwq', ['target' => '_blank', 'class' => 'box_button fl download_link']) ?>
...
elseif (Yii::$app->session->getFlash('benefit_success')) {
    echo \kartik\growl\Growl::widget([
        'type' => (!empty($message['type'])) ? $message['type'] : 'success',
        'title' => (!empty($message['title'])) ? Html::encode($message['title']) : 'Notification!',
        'icon' => (!empty($message['icon'])) ? $message['icon'] : 'fa fa-info',
        'body' => (!empty($message['message'])) ? Html::encode($message['message']) : Yii::t('yii', Yii::t('yii', 'It is not applicable you are bellow retirement age instead test for Projection')),
        'showSeparator' => true,
        'delay' => 1, //This delay is how long before the message shows
        'pluginOptions' => [
            'delay' => (!empty($message['duration'])) ? $message['duration'] : 5000, //This delay is how long the message shows for
                ...
                <div class="col-md-6">
                    <ul>
                        <li>
                            ...
                            <a title="Twitter" href="<?= $twitter ?>" target="_blank" rel="external nofollow"><i
                                        class="fab fa-twitter" style="font-size: 2em;"></i></a>
                            <a title="Facebook" href="<?= $facebook ?>" target="_blank" rel="external nofollow"><i
                                        class="fa fa-facebook" style="font-size: 2em;"></i></a>
                            <a title="Instagram" href="<?= $insta ?>" target="_blank"
                               rel="external nofollow"><i class="fa fa-instagram" style="font-size: 2em;"></i></a>
