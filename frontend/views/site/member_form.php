...
if (Yii::$app->session->getFlash('otp_success') || Yii::$app->session->getFlash('z_number') ) {
   ...
   // $url = 'https://mobile.zssf.or.tz/api/v1/static/index.php/get-zssf-member';
    $url = 'https://mobile.zssf.or.tz/api2/public/index.php/get-zssf-member';
        ...
        <div class="col-md-12">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 pr-1">
                        <div class="form-group">
                            <?= $form->field($user, 'full_names')->textInput(['maxlength' => true, 'readOnly' => true, 'value' =>'']) ?>
                        </div>
                    </div>
                    <div class="col-md-3 px-1">
                        <div class="form-group">
                            <?= $form->field($user, 'email')->textInput(['maxlength' => true, 'readOnly' => true, 'value' => '']) ?>
                        </div>
                    </div>
                    <div class="col-md-3 pl-1">
                        <div class="form-group">
                            <?= $form->field($user, 'membership_number')->textInput(['maxlength' => true, 'readOnly' => true,'value' => '']) ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 pr-1">
                        <div class="form-group">
                            <?= $form->field($user, 'date_of_birth')->textInput(['maxlength' => true, 'readOnly' => true, 'value' => '']) ?>
                        </div>
                    </div>
                    <div class="col-md-3 pl-1">
                        <div class="form-group">
                            <?= $form->field($user, 'address')->textInput(['maxlength' => true, 'readOnly' => true, 'value' => '']) ?>
                        </div>
                    </div>
                    <div class="col-md-3 pl-1">
                        <div class="form-group">
                            <?= $form->field($user, 'mobile_number')->textInput(['maxlength' => true, 'readOnly' => true, 'value' => '']) ?>
                        </div>
                    </div>
                    <div class="col-md-3 pl-1">
                        <div class="form-group">
                            <?= $form->field($user, 'gender')->textInput(['maxlength' => true, 'readOnly' => true, 'value' => '']) ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 pr-1">
                        <div class="form-group">
                            <?= $form->field($user, 'marital_status')->hiddenInput(['maxlength' => true, 'readOnly' => true, 'value' =>''])->label(false) ?>
                        </div>
                    </div>
                    <div class="col-md-3 pr-1">
                        <div class="form-group">
                            <?= $form->field($user, 'date_of_joining')->hiddenInput(['maxlength' => true, 'readOnly' => true, 'value' =>''])->label(false) ?>
                        </div>
                    </div>
                </div>
                <div class="row">
