...
if (function (a, b) {
    ...
    kb.fn = kb.prototype = {
        ...
        var A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R = "sizzle" + -new Date, S = a.document, T = 0, U = 0,
            ...
            ob = RegExp("^" + ib + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ib + "+$", "g"),
            pb = RegExp("^" + ib + "*," + ib + "*"), qb = RegExp("^" + ib + "*([>+~]|" + ib + ")" + ib + "*"),
            rb = RegExp(ib + "*[+~]"), sb = RegExp("=" + ib + "*([^\\]'\"]*)" + ib + "*\\]", "g"), tb = RegExp(nb),
            ub = RegExp("^" + lb + "$"), vb = {
                ID: RegExp("^#(" + jb + ")"),
                CLASS: RegExp("^\\.(" + jb + ")"),
    ...
    kb.Callbacks = function (a) {
        ...
        Deferred: function (a) {
            ...
            var b, c, d, e = 0, f = fb.call(arguments), g = f.length,
                h = 1 !== g || a && kb.isFunction(a.promise) ? g : 0, i = 1 === h ? a : kb.Deferred(),
                j = function (a, c, d) {
                    return function (e) {
    ...
    kb.Animation = kb.extend(O, {
        ...
        fadeTo: function (a, b, c, d) {
            ...
            return a !== !1 && (a = a || "fx"), this.each(function () {
                var b, c = kb._data(this), d = c[a + "queue"], e = c[a + "queueHooks"], f = kb.timers,
                    g = d ? d.length : 0;
